...
class VulkanGraphicRHI : public GraphicRHI
{
public:
    ...
    {
        m_NvrhiSwapchainTextures[0] = nullptr;
        m_NvrhiSwapchainTextures[1] = nullptr;
    ...
    bool CreateSwapchain(uint32_t width, uint32_t height) override
    {
        ...
        m_SwapchainFormat = VkFormatToNvrhiFormat(static_cast<VkFormat>(selectedFormat.format));
        m_SwapchainExtent.x = swapExtent.width;
        m_SwapchainExtent.y = swapExtent.height;
        ...
        // Wrap swapchain images in NVRHI textures
        for (uint32_t i = 0; i < SwapchainImageCount; ++i)
        {
            nvrhi::TextureDesc textureDesc;
            textureDesc.width = m_SwapchainExtent.x;
            textureDesc.height = m_SwapchainExtent.y;
            ...
            m_NvrhiSwapchainTextures[i] = m_NvrhiDevice->createHandleForNativeTexture(
    ...
    void DestroySwapchain()
    {
        ...
        m_SwapchainFormat = nvrhi::Format::UNKNOWN;
    ...
    const char* PhysicalDeviceTypeString(vk::PhysicalDeviceType type)
    {
        ...
        case vk::PhysicalDeviceType::eVirtualGpu: return "GPU";
    ...
    VkImage m_SwapchainImages[SwapchainImageCount] = { VK_NULL_HANDLE };
    VkImageView m_SwapchainImageViews[SwapchainImageCount] = { VK_NULL_HANDLE };
