...
int main(int argc, char** argv)
{
    ...
    out <<
        ...
        "    struct ShaderEntry\n"
        "    {\n"
        "        const char* key;        // Cache key matching Renderer::GetShaderHandle\n"
        "        const char* outputFile; // Relative to exe dir: \"shaders/dxil/<name>.dxil\"\n"
        "        const char* entryPoint; // HLSL entry point name\n"
        "        const char* definesStr; // Comma-separated \"KEY=VALUE\" pairs\n"
